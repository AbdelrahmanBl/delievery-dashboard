            ...
            <div class="block-header">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6 col-sm-12 text-right hidden-xs">
                        <button  id="approveBtn" onclick='approve(<?php echo e(basename((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] === 'on' ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]")); ?>)' class="btn btn-primary btn-sm" <?php if($Provider->status == 'approved'): ?> disabled <?php endif; ?>><?php if($Provider->status == 'approved'): ?> Approved <?php else: ?> Approve <?php endif; ?></button>
                    </div>
                </div>
            </div>
            <div class="row clearfix">
                    ...
                    <div class="card social">
                        <div class="profile-header d-flex justify-content-between justify-content-center">
                            <div class="d-flex">
                                ...
                                <div class="details">
                                    <h5 class="mb-0"><?php echo e($Provider->first_name); ?> <?php echo e($Provider->last_name); ?></h5>
                                    <span class="text-light">966 <?php echo e($Provider->mobile); ?></span>
                                    <p class="mb-0"><span>Orders: <strong><?php echo e($COMPLETED); ?></strong></span> <span>Scheduled: <strong><?php echo e($SCHEDULED); ?></strong></span> <span>Cancelled: <strong><?php echo e($CANCELLED); ?></strong></span></p>
                                </div>                                
                            </div>
                            <div>
                            <button id="block" onclick="blockProvider('<?php echo e($provider_id); ?>')" <?php if($Provider->status == 'banned'): ?> disabled <?php endif; ?> class="btn btn-primary btn-sm"><?php if($Provider->status == 'banned'): ?> Blocked <?php else: ?> Block <?php endif; ?></button>
                            ...
                            <div class="row clearfix">
                                    <div class="table-responsive">
                                            <table class="table table-hover js-basic-example dataTable table-custom spacing5 mb-0">
                                                ...
                                                <tbody>
                                                    <?php if(count($ProviderDocuments) > 0): ?>
                                                    <?php $__currentLoopData = $ProviderDocuments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr id="DIVOFDOC<?php echo e($Document->id); ?>">
                                                        <td><span><?php echo e($Document->id); ?></span></td>
                                                        <td><?php echo e($Document->doc_name); ?></td>
                                                        <td class="static"><span id="status<?php echo e($Document->id); ?>" class="badge <?php if($Document->status == 'ACTIVE'): ?> badge-success <?php else: ?> badge-danger <?php endif; ?> ml-0 mr-0"><?php echo e($Document->status); ?></span></td>
                                                        <td><input placeholder="Like : 2020-01-01" type="text" id="input<?php echo e($Document->id); ?>" value="<?php echo e($Document->expires_at); ?>"><button id="btnEx<?php echo e($Document->id); ?>" onclick="updateExpiry(<?php echo e($Document->id); ?>)">Save</button></td>
                                                        <td>
                                                                <button data-toggle="modal" data-target="#modal<?php echo e($loop->iteration); ?>" type="button" class="btn btn-sm btn-default " title="Print" data-toggle="tooltip" data-placement="top"><i class="icon-printer"></i></button>
                                                                <button onclick="deleteDocument('<?php echo e($Document->id); ?>')" type="button" class="btn btn-sm btn-default" title="Delete" data-toggle="tooltip" data-placement="top"><i class="icon-trash text-danger"></i></button>
                                                            </td>
<!-- Start Modal Box Image Viewer -->
<div class="col-lg-4 col-md-12 mb-4">
    <!--Modal: Name-->
    <div class="modal fade" id="modal<?php echo e($loop->iteration); ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
      <div class="modal-dialog modal-lg image-viewer" role="document">

        <!--Content-->
        <div class="modal-content">
            <img style="width: 100%;" src="https://api.tatx.com/<?php echo e($Document->url); ?>">
          <!--Footer-->
                ...
                <div class="col-xl-4 col-lg-4 col-md-5">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <p style="display: block;width: 79px;" class="badge <?php if($Provider->provider_status == 'Online'): ?> badge-success <?php else: ?> badge-danger <?php endif; ?> ml-0 mr-0"><?php echo e($Provider->provider_status); ?></p>
                                <hr>
                                <small class="text-muted">Service Status : </small>
                            <p id="status" style="display: block;width: 79px;" class="badge <?php if($Provider->status == 'approved'): ?> badge-success <?php else: ?> badge-danger <?php endif; ?> ml-0 mr-0"><?php if($Provider->status == 'approved'): ?><?php echo e('APPROVED'); ?><?php else: ?> <?php echo e($Provider->status); ?> <?php endif; ?></p>
                            <hr>
                                <small class="text-muted">Rating : </small>
                                <p><?php echo e($Provider->rating); ?></p>                            
                            <hr>
                            <small class="text-muted">Email address : </small>
                            <p><?php echo e($Provider->email); ?></p>                            
                            <hr>
                            <small class="text-muted">Mobile: </small>
                            <p>+966 <?php echo e($Provider->mobile); ?></p>
                            
                            <small class="text-muted">Provider Services : </small>
                            <div class="col-12">
                                
                                <ul class="list-group mb-3 tp-setting" id="ProviderService">
                                    <?php if(count($ProviderService) > 0): ?>
                            ...
                            <div class="col-12">
                                ...
                                <ul class="list-group mb-3 tp-setting" id="TOGGLE">
                                    <?php if(count($serviceTypeSmart) > 0): ?>
                                    <?php $__currentLoopData = $serviceTypeSmart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        <?php echo e($service->name); ?>

                                        <div class="float-right">
                                            <label class="switch">
                                            <input id="status<?php echo e($service->id); ?>" onclick="changeSmartService('<?php echo e($service->id); ?>','<?php echo e($provider_id); ?>')" type="checkbox" <?php if($service->status == 'ON'): ?> checked <?php endif; ?>>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                    </li>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                            <div class="form-group">
                                                    <select id="service" class="form-control">
                                                        ...
                                                        <option id="option<?php echo e($service->id); ?>" value="<?php echo e($service->id); ?>"><?php echo e($service->name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php endif; ?>
                                                    </select>
                                                </div>
...
function changeSmartService(service_id,provider_id){
    $('#TOGGLE').find('input').prop('disabled', true);
        $.ajax({
            ...
            data: {_token:"<?php echo e(csrf_token()); ?>", service_id:service_id , provider_id:provider_id }
        }).done(function(data){ 
            if(data['status'] == 0){
                if(data['result'] == 'ON'){
...
function updateService(){
    ...
    $.ajax({
            ...
            dataType: "json",
            url: "/updateService", 
            data: {_token:"<?php echo e(csrf_token()); ?>", service_type_id:service_id 
            , service_model:model ,service_number:plate , provider_id: "<?php echo e($provider_id); ?>" }
        }).done(function(data){ 
            if(data['status'] == 0){
...
function blockProvider(id){
    ...
    $.ajax({
            ...
            dataType: "json",
            url: "/blockProvider", 
            data: {_token:"<?php echo e(csrf_token()); ?>", provider_id:id  }
        }).done(function(data){ 
            if(data['status'] == 0){
                $('#block').html('Blocked')
                $('#status').html('BANNED')
...
function updateExpiry(id){
    ...
    $.ajax({
            ...
            dataType: "json",
            url: "/updateExpiry", 
            data: {_token:"<?php echo e(csrf_token()); ?>",  expires_at:expires_at , id:id }
        }).done(function(data){ 
            if(data['status'] == 0){
...
function approve(provider_id){
    ...
    $.ajax({
            ...
            dataType: "json",
            url: "/approveProvider", 
            data: {_token:"<?php echo e(csrf_token()); ?>", provider_id:provider_id }
        }).done(function(data){ 
            if(data['status'] == 0){
                $('#block').prop('disabled', false);
                $('#block').html('Block')
...
</html><?php /**PATH C:\xampp\htdocs\Admin\resources\views/Admin/providerInfo.blade.php ENDPATH**/ ?>