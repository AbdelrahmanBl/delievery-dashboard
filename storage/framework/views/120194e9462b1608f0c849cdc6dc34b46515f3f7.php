                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>SAR <?php echo e($Order->provider_wallet_balance); ?></td>
                                                <td><?php echo e($Order->Completed_Orders); ?></td>
                                                <td><?php echo e($Order->Canceled_Orders); ?></td>
                                                <td><?php echo e($Order->provider_rate); ?></td>
                                                <td><span class="badge <?php if($Order->provider_status == 'document'): ?> badge-danger <?php else: ?> badge-success <?php endif; ?> ml-0 mr-0"><?php echo e($Order->provider_status); ?></span></td>
                                                <td><span class="badge <?php if($Order->provider_online == 'Offline'): ?> badge-danger <?php else: ?> badge-success <?php endif; ?> ml-0 mr-0"><?php echo e($Order->provider_online); ?></span></td>
                                                <td>
                                                        <button type="button" class="btn btn-sm btn-default" onclick="location.href = '<?php echo e(asset('providers')); ?>/<?php echo e($Order->provider_id); ?>'" title="Documents" data-toggle="tooltip" data-placement="top"><i class="icon-printer"></i></button>
                                                    <button type="button" onclick="loadWallet(<?php echo e($Order->provider_id); ?>)" id="walletBtn<?php echo e($Order->provider_id); ?>" class="btn btn-sm btn-default " title="Wallet" data-toggle="tooltip" data-placement="top"><i class="icon-wallet"></i></button>
                                                </td>
                                            </tr>
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/Admin/providers.blade.php ENDPATH**/ ?>