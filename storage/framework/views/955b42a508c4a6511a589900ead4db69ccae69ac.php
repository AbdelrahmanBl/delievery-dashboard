                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="DIVOFDOC<?php echo e($Service->id); ?>">
                                                <td class="width45">
                                                    <div class="avtar-pic w35 bg-pink" data-toggle="tooltip" data-placement="top" title="<?php echo e($Service->name); ?>"><span><img width="100%" id="image<?php echo e($Service->id); ?>" src="<?php echo e($Service->image); ?>"></span></div>
                                                </td>
                                                <td>
                                                    <h6 id="name<?php echo e($Service->id); ?>" class="mb-0"><?php echo e($Service->name); ?></h6>
                                                    <span><?php echo e($Service->description); ?></span>
                                                </td>
                                                <td id="type<?php echo e($Service->id); ?>"><?php echo e($Service->type); ?></td>
                                                <td id="capacity<?php echo e($Service->id); ?>"><?php echo e($Service->capacity); ?></td>
                                                <td id="price_fixed<?php echo e($Service->id); ?>"><?php echo e($Service->price_fixed); ?></td>
                                                <td id="price_minute<?php echo e($Service->id); ?>"><?php echo e($Service->price_minute); ?></td>
                                                <td id="price_distance<?php echo e($Service->id); ?>"><?php echo e($Service->price_distance); ?></td>
                                                <td><span id="status<?php echo e($Service->id); ?>" class="badge <?php if($Service->status == 1): ?> badge-success <?php else: ?> badge-danger <?php endif; ?> ml-0 mr-0"><?php echo e(($Service->status == 1) ? 'AVAILABLE': 'LOCKED'); ?></span></td>
                                                <td>
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/Admin/services.blade.php ENDPATH**/ ?>