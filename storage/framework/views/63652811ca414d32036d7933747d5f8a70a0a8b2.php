                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-custom spacing8">
                                        ...
                                        <tbody id="docs">
                                            ...
                                            <tr id="DIVOFDOC<?php echo e($Setting->id); ?>">
                                                    <td><?php echo e($Setting->key); ?></td>>
                                                <td><?php echo e((strlen($Setting->value) > 70)?substr($Setting->value, 0, 70) .'....':$Setting->value); ?></td>                                        
                                                <td>
                                                        <button type="button" class="btn btn-sm btn-default" title="Edit"><i class="fa fa-edit"></i></button>
                                                        <button type="button" class="btn btn-sm btn-default js-sweetalert" title="Delete" onclick="deleteSetting('<?php echo e($Setting->id); ?>')"><i class="fa fa-trash-o text-danger"></i></button>
                                                    </td>
                                            </tr>
...
<script>
    function addSetting(){
        ...
        $.ajax({
            ...
            dataType: "json",
            url: "/addSetting", 
            data: {_token:"<?php echo e(csrf_token()); ?>", key:key , value:value }
        }).done(function(data){
            if(data['status'] == 0){
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/Admin/settings.blade.php ENDPATH**/ ?>