                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-left">
                        <div class="navbar-btn">
                            <a href="index.html"><img src="https://scontent.fcai3-1.fna.fbcdn.net/v/t1.15752-0/p280x280/93118472_1243456366000420_6004952514233892864_n.jpg?_nc_cat=111&_nc_sid=b96e70&_nc_ohc=qMOybtVGLR8AX-cDTmh&_nc_ht=scontent.fcai3-1.fna&_nc_tp=6&oh=a2bb37258394b6292e03af55c0a40355&oe=5EBB0293" alt="Oculux Logo" class="img-fluid logo"></a>
                        ...
                        <div id="navbar-menu">
                            <ul class="nav navbar-nav">
                               <!--  <li><a href="javascript:void(0);" class="search_toggle icon-menu" title="Search Result"><i class="icon-magnifier"></i></a></li> -->
                                ...
                                <li><a href="<?php echo e(asset('logout')); ?>" class="icon-menu"><i class="icon-power"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="progress-container"><div class="progress-bar" id="myBar"></div></div>
            </nav><?php /**PATH C:\xampp\htdocs\Admin\resources\views/layouts/Admin/topNav.blade.php ENDPATH**/ ?>