...
<head>
<title>TATX | Forgot Password</title>
<meta charset="utf-8">
            ...
            <div class="body">
                ...
                <form class="form-auth-small" action="index.html">
                    <div class="form-group">                                    
                        <input type="email" class="form-control round" id="signup-password" placeholder="Your Email">
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/Main/forgot.blade.php ENDPATH**/ ?>