    ...
    <div class="auth_div vivify popIn">
        ...
        <div class="card">
            <div class="body">
                ...
                <?php if(session('login') || $errors->any()): ?>
                ...
                <form class="form-auth-small m-t-20" action="login" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control round" id="signin-email" value="<?php echo e(old('email')); ?><?php echo e(session('email')); ?>" placeholder="Email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group clearfix">
                        <label class="fancy-checkbox element-left">
                            <input <?php if(old('status') == 'ADMIN' || session('status') == 'ADMIN'): ?>checked <?php endif; ?> name="status" required value="ADMIN" type="radio">
                            <span>Admin</span>
                        </label> 
                        <label class="fancy-checkbox element-left">
                            <input <?php if(old('status') == 'FLEET' || session('status') == 'FLEET'): ?>checked <?php endif; ?> name="status" value="FLEET" type="radio">
                            <span>Fleet</span>
                        </label>                                
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/Main/login.blade.php ENDPATH**/ ?>