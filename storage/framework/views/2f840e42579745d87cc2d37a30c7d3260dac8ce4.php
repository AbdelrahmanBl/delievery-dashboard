                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        ...
                                        <tbody id="tableData">
                                            ...
                                            <tr id="DIVOFDOC<?php echo e($Service->id); ?>">
                                                ...
                                                <td>
                                                    <h6 class="mb-0"><?php echo e($Service->category_english); ?></h6>
                                                </td>
                                                <td><?php echo e($Service->category_arabic); ?></td>
                                                <td id="subEn<?php echo e($Service->id); ?>">
                                                    <?php echo e(count($Service->subCategory_english)); ?></td>
                                                    <input value="<?php $__currentLoopData = $Service->subCategory_english; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($item . ','); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" type="hidden" id="subEnArr<?php echo e($Service->id); ?>">
                                                <td id="subAr<?php echo e($Service->id); ?>">
                                                    <?php echo e(count($Service->subCategory_arabic)); ?></td>
                                                    <input value="<?php $__currentLoopData = $Service->subCategory_arabic; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($item . ','); ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" type="hidden" id="subArArr<?php echo e($Service->id); ?>">
                                                <td ><?php echo e($Service->created_at); ?></td>
                                                
                                                <td>
                                                    <button id="updateBtn<?php echo e($Service->id); ?>" onclick="openUpdateService('<?php echo e($Service->id); ?>')" type="button" class="btn btn-sm btn-default" title="Edit"><i class="fa fa-edit"></i></button>
                                                    </td>
                                            </tr>
...
<?php /**PATH C:\xampp\htdocs\Admin\resources\views/Admin/categories.blade.php ENDPATH**/ ?>