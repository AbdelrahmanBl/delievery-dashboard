                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        ...
                                        <tbody id="docs">
                                            ...
                                            <tr id="DIVOFDOC{{$Document->id}}">
                                                ...
                                                <td>{{$Document->type}}</td>                                        
                                                <td>
                                                        <button onclick="deleteDoc('{{$Document->id}}')" type="button" class="btn btn-sm btn-default js-sweetalert" title="Delete" ><i class="fa fa-trash-o text-danger"></i></button>
                                                    </td>
                                            </tr>
                                            @endforeach
                                            @endif
...
<script>
    function addDoc(){
        ...
        $.ajax({
            ...
            dataType: "json",
            url: "/addDoc", 
            data: {_token:"{{csrf_token()}}", service_name:service_name , service_type:service_type }
        }).done(function(data){
            if(data['status'] == 0){
