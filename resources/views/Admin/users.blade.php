                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>SAR {{$Order->user_wallet_balance}}</td>
                                                <td>{{$Order->Completed_Orders}}</td>
                                                <td>{{$Order->Canceled_Orders}}</td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-default " onclick="loadWallet({{$Order->user_id}})" id="walletBtn{{$Order->user_id}}"  title="Print" ><i class="icon-wallet"></i></button>
